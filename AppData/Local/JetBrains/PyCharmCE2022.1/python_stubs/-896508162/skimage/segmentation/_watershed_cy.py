# encoding: utf-8
# module skimage.segmentation._watershed_cy
# from F:\Aanaconda\lib\site-packages\skimage\segmentation\_watershed_cy.cp39-win_amd64.pyd
# by generator 1.147
"""
...
import numpy as np # F:\Aanaconda\lib\site-packages\numpy\__init__.py
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000231EE2137F0>'

__spec__ = None # (!) real value is "ModuleSpec(name='skimage.segmentation._watershed_cy', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000231EE2137F0>, origin='F:\\\\Aanaconda\\\\lib\\\\site-packages\\\\skimage\\\\segmentation\\\\_watershed_cy.cp39-win_amd64.pyd')"
